...
## 1. Bölüm: Viterbi El Hesaplaması [cite: 3]
"EV" kelimesi için gözlem dizimiz: `[High, Low]` 



### Adım 1: Başlangıç (t=1, Gözlem: High)
* **e durumu:** $P(e) \times P(High|e) = 1.0 \times 0.7 = 0.7$ 
* **v durumu:** $P(v) \times P(High|v) = 0.0 \times 0.1 = 0.0$ 

### Adım 2: Geçiş (t=2, Gözlem: Low)
* **e durumuna geçiş:** $\max(0.7 \times 0.6 \times 0.3, 0 \times 0.2 \times 0.3) = 0.126$
* **v durumuna geçiş:** $\max(0.7 \times 0.4 \times 0.9, 0 \times 0.8 \times 0.9) = 0.252$ 

**Sonuç:** $0.252 > 0.126$ olduğu için en olası fonem dizisi **"e-v"** olarak hesaplanmıştır. 

## 3. Bölüm: Analiz ve Yorumlama 

**1. Ses verisindeki gürültü emisyon olasılıklarını nasıl etkiler? **
...
**2. Neden Viterbi yerine Derin Öğrenme tercih ediliyor? **
